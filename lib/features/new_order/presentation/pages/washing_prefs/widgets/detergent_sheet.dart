...
class DetergentSheet extends StatefulWidget {
  const DetergentSheet({super.key});

  @override
  _DetergentSheetState createState() => _DetergentSheetState();
}

class _DetergentSheetState extends State<DetergentSheet> {
        ...
        return Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              _buildOption('Color Safe'),
              const SizedBox(height: 12),
              _buildOption('Hypoallergenic'),
              const SizedBox(height: 12),
              _buildOption('Stain-Remover'),
            ],
          ),
        );
      },
  ...
  Widget build(BuildContext context) {
    String headline = 'My prefered detergent is';
    return Column(
